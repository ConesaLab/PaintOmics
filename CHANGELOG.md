...
- A walk's statements and Results could still narrate the walk in other words ("a network walk from the seed miRNA miR-151-3p", "the seed miRNA mmu-miR-3074-1-3p"), which the check for "cluster" and "the walk" let through. Those forms are refused too; a miRNA's seed region and a plant's seeds are not.
